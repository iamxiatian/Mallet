...
public class StringEditFeatureVectorSequence extends FeatureVectorSequence implements Serializable {
    ...
    public String getString1BlockAtIndex(int idx) {
        if (idx < 0 || idx >= block1Indices.length || block1Indices[idx] < 0 || block1Indices[idx] >= string1Blocks.length)
            return null;
    ...
    public String getString2BlockAtIndex(int idx) {
        if (idx < 0 || idx >= block2Indices.length || block2Indices[idx] < 0 || block2Indices[idx] >= string2Blocks.length)
            return null;
