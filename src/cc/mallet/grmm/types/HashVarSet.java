...
public class HashVarSet extends HashSet<Variable> implements VarSet, Serializable {

    private static final long serialVersionUID = 1;
    private static final int CURRENT_SERIAL_VERSION = 1;
    private THashSet<Variable> verts = new THashSet<>();
...
// Code for delegation of java.util.AbstractCollection methods to verts
    ...
    public boolean addAll(Collection<? extends Variable> collection) {
        boolean ret = true;
        for (Iterator<? extends Variable> it = collection.iterator(); it.hasNext();
        ) {
...
// Code for delegation of java.util.HashSet methods to verts
    ...
    public boolean add(Variable object) {
        return add(object, true);
    }

    public boolean add(Variable object, boolean checkSorted) {
