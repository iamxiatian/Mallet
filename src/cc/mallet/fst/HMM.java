...
public class HMM extends Transducer implements Serializable {
     ...
     * @param orders         an array of increasing non-negative numbers giving the orders
     ...
     *                       HMM is built.
     * @param defaults       If non-null, it must be the same length as <code>orders</code>
     ...
     * @param start          The label that represents the context of the start of a
     *                       sequence. It may be also used for sequence labels.
     * @param forbidden      If non-null, specifies what pairs of successive labels are not
     ...
     *                       <code>forbidden</code>.
     * @param allowed        If non-null, specifies what pairs of successive labels are
     *                       allowed, both for constructing <em>n</em>order states or for
     *                       transitions. A label pair (<em>u</em>,<em>v</em>) is allowed
     *                       only if <em>u</em> + "," + <em>v</em> matches
     *                       <code>allowed</code>.
     * @param fullyConnected Whether to include all allowed transitions, even those not
