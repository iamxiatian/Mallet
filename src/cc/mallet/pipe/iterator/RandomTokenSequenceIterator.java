...
public class RandomTokenSequenceIterator implements Iterator<Instance> {
    ...
    public Alphabet getAlphabet() {
        return classCentroidDistribution.getAlphabet();
    }
    ...
    public Instance next() {
        ...
        URI uri = null;
        try {
            uri = new URI("random:" + classNames[currentClassIndex] + "/" + currentInstanceIndex);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public boolean hasNext() {
        return !(currentClassIndex <= 0 && currentInstanceIndex <= 0);
    }
